...
public partial class ShipmentDetailOsHistMap : ClassMap<ShipmentDetailOsHist> {
    
    public ShipmentDetailOsHistMap() {
			Table("shipment_detail_os_hist");
			LazyLoad();
			...
			Map(x => x.revision_no).Column("revision_no");
